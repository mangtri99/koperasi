                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form method="post" action="/bungaSimpanan" role="form">
                                    {{ csrf_field() }}
                                        <div class="form-label">
                                            <label for="persentase">Presentase Bunga</label>
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" id="persentase" name="persentase" placeholder="Bunga Bulan Ini" />
                                        </div>
                                        <input hidden value="" />
                                        <div class="form-label">
                                        ...
                                        <div class="form-group">
                                            <input type="date" class="form-control" id="tanggal-mulai-berlaku" name="tanggal_mulai_berlaku" placeholder="Masukkan Tanggal Mulai Berlaku Bunga">
                                        </div>
                                        <div class="form-group">
