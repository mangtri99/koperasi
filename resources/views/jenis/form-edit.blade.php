...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form action="/jenis/{{ $datajenis->id }}" method="POST" class="form-group">
                @csrf
                @method("PUT")
                <div class="form-header">
                    <h3>Form Edit Jenis Transaksi</h3>
                </div>
                
                <div class="form-body">
                    
                        <div class="form-label">
                            <label for="nim">Transaksi</label>
                        </div>
                        <input type="text" class="form-control" name="transaksi" value="{{$datajenis->transaksi}}" />
                        <div class="form-label">
                            <label for="nama">Tipe</label>
                        </div>
                        <input type="text" class="form-control" name="tipe" value="{{$datajenis->tipe}}"/> 
