                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                @foreach ($admin as $user)
                                    <form method="post" action="/admin/{{$user->id}}" role="form">
                                        {{ method_field('PUT') }}
                                        {{ csrf_field() }}
                                        <div class="form-group">
                                            <input class="form-control" name="nik" placeholder="NIK Pegawai" value="{{$user->nik}}" />
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" name="nama" placeholder="Nama Pegawai" value="{{$user->nama}}" />
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" name="username" placeholder="Username Pegawai" value="{{$user->username}}" />
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" name="password" placeholder="Password Telepon" value="{{$user->password}}" />
                                        </div>
                                        <div class="form-group">
                                             <select name="user_role" class="form-control">
                                                @if ($user->user_role==1)
                                                <option disabled>Pilih User Role</option>
                                                <option selected value="1">Pengelola Simpanan</option>
                                                <option value="2">Pengelola Pinjaman</option>
                                                @else
                                                <option disabled>Pilih User Role</option>
                                                <option value="1">Pengelola Simpanan</option>
                                                <option selected value="2">Pengelola Pinjaman</option>
                                                @endif   
                                            </select>
                                        </div>
