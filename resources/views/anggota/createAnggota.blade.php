...
<div id="wrapper">
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form method="post" action="/anggota" role="form">
                                    {{ csrf_field() }}
 ...
 -->                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input class="form-control" name="alamat" placeholder="Alamat Anggota" />
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" name="telp" placeholder="Nomer Telepon" />
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" name="ktp" placeholder="Nomer KTP Anggota" />
                                        </div>
                                         <div class="form-group">
